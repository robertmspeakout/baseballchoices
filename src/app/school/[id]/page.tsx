    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-4 sm:py-8 space-y-4 sm:space-y-6">
        ...
        {activeDetailTab === "tracking" && (
          <>
            {/* Recruiting Tracker */}
            <div className="rounded-xl border-2 border-red-300 shadow-md overflow-hidden">
              <div className="bg-red-700 px-4 sm:px-6 py-3 flex items-center gap-2">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                </svg>
                <h2 className="text-base sm:text-lg font-bold text-white">Recruiting Tracker</h2>
              </div>
              <div className="bg-red-50/60 p-4 sm:p-6">
              <div className="space-y-4">
                {/* Recruiting Status */}
                <div>
