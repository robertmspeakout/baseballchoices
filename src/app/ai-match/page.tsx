    ...
    <AuthGate>
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <main className="flex-1 max-w-[1400px] mx-auto w-full px-3 sm:px-6 py-4 sm:py-6 flex flex-col">
          ...
          <div className="flex items-center border border-[#e0e0e5] bg-[#e8e8ed] rounded-[100px] hover:border-[#c0c0c5] hover:shadow-[0_1px_4px_rgba(0,0,0,0.08)] transition-all mb-4">
