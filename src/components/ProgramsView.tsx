  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <main className="max-w-[1400px] mx-auto px-3 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
        {mode !== "ai" && <div className="flex items-center border border-[#e0e0e5] bg-[#e8e8ed] rounded-[100px] hover:border-[#c0c0c5] hover:shadow-[0_1px_4px_rgba(0,0,0,0.08)] transition-all">
